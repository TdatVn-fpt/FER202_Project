  ...
  return (
    <div className="container-fluid py-4">
      <div className="d-flex justify-content-between align-items-center mb-4">
        <div>
          <h2 className="fw-bold mb-1">Lesson Management</h2>
          <p className="text-muted mb-0">Quản lý toàn bộ bài học trong hệ thống</p>
        </div>
        <Badge bg="success" className="fs-6 px-3 py-2">{lessons.length} Bài học</Badge>
      </div>
        ...
        <div className="card-body">
          <Form className="row g-3 align-items-end">
            ...
            <div className="col-md-4">
              <Form.Select name="status" value={filters.status} onChange={handleFilterChange} className="rounded-pill" id="lesson-status-filter">
            ...
            <div className="col-md-3">
              <Button variant="primary" className="w-100 rounded-pill" onClick={fetchLessons} id="lesson-filter-btn">
                Lọc
              </Button>
            </div>
          </Form>
